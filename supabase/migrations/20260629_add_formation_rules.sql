-- ============================================================================
-- CANTANHEDE CYCLING HUB - Migração para Regras de Formação (UVP-FPC)
-- Executar no SQL Editor do Supabase para atualizar as tabelas existentes e criar novas.
-- ============================================================================
...
COMMENT ON COLUMN athletes.encarregado_educacao_nome IS 'Nome do encarregado de educação (obrigatório para menores)';
...
-- Limpar e criar Políticas RLS para athlete_equipment
...
ADD COLUMN IF NOT EXISTS pedagogical_status TEXT, -- 'Completou com êxito' ou 'Continua o seu processo de formação ciclista'
...
-- Limpar e criar Políticas RLS para team_staff
