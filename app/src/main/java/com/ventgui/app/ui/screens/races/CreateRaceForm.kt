...
fun CreateRaceForm(
    ...
    var category by rememberSaveable { mutableStateOf("BTT") }
    var status by rememberSaveable { mutableStateOf("Agendada") }
    var location by rememberSaveable { mutableStateOf("") }
    var description by rememberSaveable { mutableStateOf("") }
    var link by rememberSaveable { mutableStateOf("") }
    var selectedSubCats by rememberSaveable { mutableStateOf(emptyList<String>()) }
    var selectedAthleteIds by remember { mutableStateOf(emptySet<String>()) }
    var startTime by rememberSaveable { mutableStateOf("") }
    
    var raceFormat by rememberSaveable { mutableStateOf("Estrada") }
    var distanceKm by rememberSaveable { mutableStateOf("") }
    var durationMinutes by rememberSaveable { mutableStateOf("") }
    var subStagesList by remember { mutableStateOf(emptyList<com.ventgui.app.data.model.RaceSubStage>()) }
    ...
    var bttGender by rememberSaveable { mutableStateOf("Misto") }
    var estradaGender by rememberSaveable { mutableStateOf("Misto") }
    var pistaGender by rememberSaveable { mutableStateOf("Misto") }
    var bttAgeGroupTypes by remember { mutableStateOf(emptySet<String>()) }
    var estradaAgeGroupTypes by remember { mutableStateOf(emptySet<String>()) }
    var pistaAgeGroupTypes by remember { mutableStateOf(emptySet<String>()) }
            ...
            Column(modifier = Modifier.padding(24.dp).fillMaxHeight()) {
                ...
                Column(modifier = Modifier.fillMaxWidth()) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(
                            text = stringResource(R.string.races_add_race),
                            color = Color.White,
                            fontSize = 18.sp,
                        ...
                        PremiumButton(
                            ...
                            onClick = {
                                scope.launch {
                                    ...
                                    val success = onSave(newRace, selectedAthleteIds)
